...
public class Main extends JavaPlugin {
    ...
    public ItemStack instantPotion(){ItemStack item=new ItemStack(Material.POTION);ItemMeta meta=item.getItemMeta();meta.setDisplayName(ChatColor.LIGHT_PURPLE+"Instant Revive Potion");meta.setLore(java.util.List.of(ChatColor.GRAY+"Right-click a downed player",ChatColor.GRAY+"to revive them immediately."));meta.getPersistentDataContainer().set(instantPotionKey,PersistentDataType.BYTE,(byte)1);item.setItemMeta(meta);return item;}
